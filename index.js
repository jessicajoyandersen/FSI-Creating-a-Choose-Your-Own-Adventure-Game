...
if(firstAnswer === 'left'){
    ...
    if (secondAnswer === 'follow'){
        let thirdAnswer = window.prompt(
            `You follow the cat to a colony of cats, nestled in a fort of warm blankets and subsisting off of inexplicably warm soup. 
...
//code just above will not run

    if (secondAnswer === 'continue'){
        let thirdAnswer = window.prompt(
            `You come across a chamber that reaches upward to a shining light above. 
            ...
            if (thirdAnswer === 'ladder'){
                let fourthAnswer = window.alert(
                    `After ascending a few feet up the ladder, one of its rungs snaps, and you comedically fall through each of the rungs below. 
    ...
    if (secondAnswer === 'past the dragon'){
        let thirdAnswer = window.prompt(
            `The dragon wakes up and sits upright. 
    ...
    if (secondAnswer === "away from the dragon"){
        let thirdAnswer = window.prompt(
            `After walking a while longer, you come across a shiny blue flower. 
            ...
            if (thirdAnswer === 'draw it'){
                let fourthAnswer = window.alert(
                    `You draw the flower, capturing only a fraction of its beauty with your quill. 
                ...
                let fourthAnswer = window.alert(
                `You pick the flower and bring it home, and all marvel at its brilliance. 
